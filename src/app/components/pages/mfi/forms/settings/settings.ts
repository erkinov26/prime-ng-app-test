  ...
  input_fields: InputFieldsI[] = [
    {
      ...
      class: 'w-[40%] flex gap-2 items-center [&>*:nth-child(1)]:w-[45%]',
    },
    {
      ...
      class: 'w-[40%] flex [&>*:nth-child(1)]:w-[38%] gap-2 items-center',
    },
    {
    ...
    },
    {
      ...
      class: 'w-[20%] flex items-center gap-2',
    },
    {
      ...
      class: 'w-[40%] flex [&>*:first-child]:w-[45%] items-center',
    },
    {
      ...
      class: 'w-[20%] flex items-center [&>*:first-child]:w-[90%]',
    },
    {
      ...
      class: 'w-[20%]  flex items-center [&>*:nth-child(2)]:w-[60%] gap-2',
    },
    {
      ...
      class: 'w-[25%] flex [&>*:nth-child(2)]:w-[48%] items-center gap-2',
    },
    {
